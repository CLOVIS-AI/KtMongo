...
@Serializable
data class ClientSideViewOperationsUser(
	val _id: ObjectId,
	val name: String,
	val age: Int,
)

fun SuiteDsl.verifyClientSideViewOperations(
	client: Prepared<MongoClient>,
) = suite("ClientSideView operations") {
	val collection by client.collection<ClientSideViewOperationsUser>("operation-clientsideview-users")

...
package opensavvy.ktmongo.tests.api.scenarii.unionwith
 ...
 * ```
 */
fun SuiteDsl.verifyScenarioUnionWith(
	client: Prepared<MongoClient>,
) {

	val drafts by client.collection<Invoice>("scenario-unionWith-drafts")
	val invoiceAs by client.collection<Invoice>("scenario-unionWith-invoice-a")
	val invoiceBs by client.collection<Invoice>("scenario-unionWith-invoice-b")
	val invoiceCs by client.collection<Invoice>("scenario-unionWith-invoice-c")

 ...
 *
 * For more information, see [UpdateQuery.filter] and [HasArrayFilters.arrayFilter].
 */
 ...
 *
 * See [HasArrayFilters.arrayFilter].
 */
@KtMongoDsl
interface ArrayFiltersOptionDsl<Document> : CompoundBsonNode,
	...
	/**
	 * Special type used by the [HasArrayFilters.arrayFilter] lambda parameter to designate

...
interface JvmBsonFactory : BsonFactory {
	 ...
	 * When mixing KtMongo with the official driver, it is recommended to configure the official driver
	 * using this registry to ensure types are serialized identically by both libraries.
	 */
	@LowLevelApi
 ...
 *
 * Note that the [JvmBsonFactory.codecRegistry] attribute may be different from the passed [codecRegistry].
 * In particular, this function adds new codecs for KtMongo-specific types.
 * If mixing KtMongo with the official driver, we recommend configuring the official driver with the
 * [JvmBsonFactory.codecRegistry] generated by this function.
 * Otherwise, the official driver may serialize KtMongo types differently.
 */

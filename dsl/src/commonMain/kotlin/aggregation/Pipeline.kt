...
// This file is generated from dsl-template/src/commonMain/kotlin/aggregation/Pipeline.kt
 ...
 * To register the stage, call [withStage], optionally followed by [unsafeCast], and return the resulting pipeline.
 *
 * Stages should return [Pipeline] instances **that were generated by the [withStage] or [unsafeCast] methods**.
 ...
 *
 * @param Output The type of document that this pipeline results in. Changing this type is possible by calling [unsafeCast].
 */
@KtMongoDsl
interface Pipeline<Output : Any> {
	 ...
	 * ```
	 *
	 * @see unsafeCast Change the output type of this pipeline.
	 */
	@DangerousMongoApi
	@LowLevelApi

...
private class MultiplatformFilteredMongoCollectionImpl<Document : Any>(
	private val upstream: MultiplatformMongoCollection<Document>,
...
internal fun <Document : Any> createFilteredCollection(
	upstream: MultiplatformMongoCollection<Document>,
	globalFilter: FilterQuery<Document>.() -> Unit,
): MultiplatformMongoCollection<Document> =
	MultiplatformFilteredMongoCollectionImpl(upstream, globalFilter)

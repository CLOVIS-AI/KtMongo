 ...
 *
 * To obtain a pipeline, use [MongoCollection.aggregate][opensavvy.ktmongo.sync.api.operations.AggregationOperations.aggregate].
 *
 * ### Example
 *
 * ```kotlin
...
inline fun <reified Document : Any> MongoAggregationPipeline<Document>.first(): Document =
 ...
 */
@OptIn(LowLevelApi::class)
inline fun <reified Document : Any> MongoAggregationPipeline<Document>.firstOrNull(): Document? =
 ...
 */
@OptIn(LowLevelApi::class)
inline fun <reified Document : Any> MongoAggregationPipeline<Document>.forEach(noinline action: (Document) -> Unit) =
 ...
 */
@OptIn(LowLevelApi::class)
inline fun <reified Document : Any> MongoAggregationPipeline<Document>.toList(): List<Document> =
 ...
 */
@OptIn(LowLevelApi::class)
inline fun <reified Document : Any> MongoAggregationPipeline<Document>.toSet(): Set<Document> =

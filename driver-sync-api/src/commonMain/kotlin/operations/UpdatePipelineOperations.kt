...
import opensavvy.ktmongo.sync.api.operations.UpdateOperations.UpdateResult
import opensavvy.ktmongo.sync.api.operations.UpdateOperations.UpsertResult
...
interface UpdatePipelineOperations<Document : Any> : BaseOperations {
	 ...
	 * ### External resources
	 *
	 * - [Protocol documentation](https://www.mongodb.com/docs/manual/reference/command/update/#update-with-an-aggregation-pipeline)
	 * - [`mongosh` documentation](https://www.mongodb.com/docs/manual/reference/method/db.collection.updateMany/#std-label-updateMany-behavior-aggregation-pipeline)
	 *
	 ...
	 * @see UpdateOperations.updateMany Identical operation using update query operators.
	 */
	 ...
	 *
	 * - [Protocol documentation](https://www.mongodb.com/docs/manual/reference/command/update/#update-with-an-aggregation-pipeline)
	 * - [`mongosh` documentation](https://www.mongodb.com/docs/manual/reference/method/db.collection.updateOne/#std-label-updateOne-behavior-aggregation-pipeline)
	 *
	 ...
	 * @see UpdateOperations.updateOne Identical operation using update query operators.
	 */
	@IgnorableReturnValue
	 ...
	 * @see UpdateOperations.upsertOne Identical operation using update query operators.
	 */
	@IgnorableReturnValue

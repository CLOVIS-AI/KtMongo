...
import opensavvy.ktmongo.sync.api.MongoDatabase
...
interface SyncMongoDatabase : MongoDatabase {
	 ...
	 */
	fun asOfficial(): com.mongodb.kotlin.client.MongoDatabase
	...
	final inline fun <reified Document : Any> collection(name: String): SyncMongoCollection<Document> =
